...
namespace marlib {
  ...
  struct vector_traits<Rcpp::S4> {
    static int size(const Rcpp::S4& v) { return Rcpp::as<NumericVector>(v.slot("x")).length(); }
    static const double* value(const Rcpp::S4& v) { return &Rcpp::as<NumericVector>(v.slot("x"))[0]; }
    static double* value(Rcpp::S4& v) { return &Rcpp::as<NumericVector>(v.slot("x"))[0]; }
    static int inc(const Rcpp::S4& v) { return 1; }
  };

  template <>
  struct dense_matrix_traits<Rcpp::S4> {
    static int nrow(const Rcpp::S4& m) { return Rcpp::as<IntegerVector>(m.slot("Dim"))[0]; }
    static int ncol(const Rcpp::S4& m) { return Rcpp::as<IntegerVector>(m.slot("Dim"))[1]; }
    static const double* value(const Rcpp::S4& m) { return &Rcpp::as<NumericVector>(m.slot("x"))[0]; }
    static double* value(Rcpp::S4& m) { return &Rcpp::as<NumericVector>(m.slot("x"))[0]; }
    static int ld(const Rcpp::S4& m) { return Rcpp::as<IntegerVector>(m.slot("Dim"))[0]; }
  };
  ...
  struct csr_matrix_traits<Rcpp::S4> {
    static int nrow(const Rcpp::S4& m) { return Rcpp::as<IntegerVector>(m.slot("Dim"))[0]; }
    static int ncol(const Rcpp::S4& m) { return Rcpp::as<IntegerVector>(m.slot("Dim"))[1]; }
    static int nnz(const Rcpp::S4& m) { return Rcpp::as<NumericVector>(m.slot("x")).length(); }
    static int base(const Rcpp::S4& m) { return 0; }
    static double* value(Rcpp::S4& m) { return &Rcpp::as<NumericVector>(m.slot("x"))[0]; }
    static const double* value(const Rcpp::S4& m) { return &Rcpp::as<NumericVector>(m.slot("x"))[0]; }
    static const int* rowptr(const Rcpp::S4& m) { return &Rcpp::as<IntegerVector>(m.slot("p"))[0]; }
    static const int* colind(const Rcpp::S4& m) { return &Rcpp::as<IntegerVector>(m.slot("j"))[0]; }
  };
  ...
  struct csc_matrix_traits<Rcpp::S4> {
    ...
    static double* value(Rcpp::S4& m) { return &Rcpp::as<NumericVector>(m.slot("x"))[0]; }
    static const double* value(const Rcpp::S4& m) { return &Rcpp::as<NumericVector>(m.slot("x"))[0]; }
    static const int* colptr(const Rcpp::S4& m) { return &Rcpp::as<IntegerVector>(m.slot("p"))[0]; }
    static const int* rowind(const Rcpp::S4& m) { return &Rcpp::as<IntegerVector>(m.slot("i"))[0]; }
  };
