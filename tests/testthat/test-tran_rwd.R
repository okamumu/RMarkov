...
test_that("tran rwd vecT vecT forward dense", {
  ...
  res <- Ctran_unif_rwd_vec_vec(TRUE, Matrix(Q), x0, rwd, t, 1.01, 1.0e-8, 100)
...
test_that("tran rwd vecT vecT backward dense", {
  ...
  rwd <- c(1,2,3,4)
  t <- c(0.3,0.4,0.6,0.1,0.2)
  res <- Ctran_unif_rwd_vec_vec(FALSE, Matrix(Q), x0, rwd, t, 1.01, 1.0e-8, 100)
...
test_that("tran rwd vecT vecT forward csr", {
  ...
  rwd <- c(1,2,3,4)
  t <- c(0.3,0.4,0.6,0.1,0.2)
  res <- Ctran_unif_rwd_vec_vec(TRUE, spQ, x0, rwd, t, 1.01, 1.0e-8, 100)
...
test_that("tran rwd vecT vecT backward csr", {
  ...
  rwd <- c(1,2,3,4)
  t <- c(0.3,0.4,0.6,0.1,0.2)
  res <- Ctran_unif_rwd_vec_vec(FALSE, spQ, x0, rwd, t, 1.01, 1.0e-8, 100)
...
test_that("tran rwd vecT matT forward dense", {
  ...
  t <- c(0.3,0.4,0.6,0.1,0.2)
  res <- Ctran_unif_rwd_vec_mat(TRUE, Matrix(Q), x0, rwd, t, 1.01, 1.0e-8, 100)
...
test_that("tran rwd vecT matT backward dense", {
  ...
  rwd <- cbind(c(1,2,3,4), c(3,4,5,6))
  t <- c(0.3,0.4,0.6,0.1,0.2)
  res <- Ctran_unif_rwd_vec_mat(FALSE, Matrix(Q), x0, rwd, t, 1.01, 1.0e-8, 100)
  res$irwd <- array(res$irwd, dim = c(2, length(t)))
  res$crwd <- array(res$crwd, dim = c(2, length(t)))
...
test_that("tran rwd vecT matT forward csr", {
  ...
  rwd <- cbind(c(1,2,3,4), c(3,4,5,6))
  t <- c(0.3,0.4,0.6,0.1,0.2)
  res <- Ctran_unif_rwd_vec_mat(TRUE, spQ, x0, rwd, t, 1.01, 1.0e-8, 100)
  res$irwd <- array(res$irwd, dim = c(2, length(t)))
  res$crwd <- array(res$crwd, dim = c(2, length(t)))
...
test_that("tran rwd vecT matT backward csr", {
  ...
  rwd <- cbind(c(1,2,3,4), c(3,4,5,6))
  t <- c(0.3,0.4,0.6,0.1,0.2)
  res <- Ctran_unif_rwd_vec_mat(FALSE, spQ, x0, rwd, t, 1.01, 1.0e-8, 100)
  res$irwd <- array(res$irwd, dim = c(2, length(t)))
  res$crwd <- array(res$crwd, dim = c(2, length(t)))
...
test_that("tran rwd matT matT forward dense", {
  ...
  t <- c(0.3,0.4,0.6,0.1,0.2)
  res <- Ctran_unif_rwd_mat_mat(TRUE, Matrix(Q), x0, rwd, t, 1.01, 1.0e-8, 100)
...
test_that("tran rwd matT matT backward dense", {
  ...
  rwd <- cbind(c(1,2,3,4), c(3,4,5,6), c(0,1,0,0))
  t <- c(0.3,0.4,0.6,0.1,0.2)
  res <- Ctran_unif_rwd_mat_mat(FALSE, Matrix(Q), x0, rwd, t, 1.01, 1.0e-8, 100)
  res$irwd <- array(res$irwd, dim = c(3, 2, length(t)))
  res$crwd <- array(res$crwd, dim = c(3, 2, length(t)))
...
test_that("tran rwd matT matT forward csr", {
  ...
  rwd <- cbind(c(1,2,3,4), c(3,4,5,6), c(0,1,0,0))
  t <- c(0.3,0.4,0.6,0.1,0.2)
  res <- Ctran_unif_rwd_mat_mat(TRUE, spQ, x0, rwd, t, 1.01, 1.0e-8, 100)
  res$irwd <- array(res$irwd, dim = c(3, 2, length(t)))
  res$crwd <- array(res$crwd, dim = c(3, 2, length(t)))
...
test_that("tran rwd matT matT backward csr", {
  ...
  rwd <- cbind(c(1,2,3,4), c(3,4,5,6), c(0,1,0,0))
  t <- c(0.3,0.4,0.6,0.1,0.2)
  res <- Ctran_unif_rwd_mat_mat(FALSE, spQ, x0, rwd, t, 1.01, 1.0e-8, 100)
  res$irwd <- array(res$irwd, dim = c(3, 2, length(t)))
  res$crwd <- array(res$crwd, dim = c(3, 2, length(t)))
